    ...
    public String ask(String userQuestion, String service, String apiKey, String geminiModel, String gptApiUrl, String gptModel) throws Exception {
        ...
        if (allProjects.isEmpty()) {
            ...
            for (int i = 0; i < allProjects.size(); i++) {
                ...
                context.append("   Kaynak: ").append(p.source).append("\n");
                ...
                if (p.description != null && !p.description.isEmpty()) {
                    context.append("   Aciklama: ").append(p.description, 0,
                            Math.min(p.description.length(), 200)).append("...\n");
                }
                context.append("\n");
            }
        }
        ...
        String systemPrompt = "Sen akilli, samimi ve yetenekli bir yazilim proje asistanisin.\n" +
                "Kullanicinin analiz edilmis projelerini bilirsin ve ona projeleri bulmasinda ve anlamasinda yardimci olursun.\n\n" +
                ...
                "2. Kullanici genel veya konusuna dair bir soru sorarsa (örn: 'ne ile ilgili proje', 'bu ne projesi', 'konusu ne', 'ne ise yarar' vb.):\n" +
                ...
                "   - ASLA kullanicinin cümlesindeki 'ne', 'ile', 'ilgili' gibi kelimeleri ayri ayri arama terimi olarak algilama! 'Bulamadigim projeler: ne, ile' gibi sacma ve robotik cevaplar verme. Cümleyi dogal dilde bütünsel olarak anla.\n" +
                "3. Eger kullanici net bir arama veya kelime eslesmesi yapiyorsa (örn: 'python projesi var mi', 'X adinda proje var mi' vb.), " +
                ...
                "5. DİKKAT: Veritabanında TOPLAM " + projectCount + " adet proje var! SADECE bu " + projectCount + " adet projeyi listele. ASLA KENDINDEN proje uydurma!\n" +
